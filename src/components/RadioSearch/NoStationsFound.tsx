...
const NoStationsFound = () => (
	<div className="mt-6 p-4 text-sm rounded-md bg-secondary text-white text-center">
		<p>
			...
			? Good news: you can search by genre, or browse all available{" "}
			<a
				href="/search/tag"
				className="text-primary underline hover:no-underline focus:outline-none focus-visible:ring-2 focus-visible:ring-primary"
			>
				Genres
			</a>{" "}
			or{" "}
			...
			to discover online radio stations. You can also add stations to your Favorites for quick
			access.
			{!isCookiesAccepted() && (
